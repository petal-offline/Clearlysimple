...
export function Header() {
	...
	const links = [
		...
		{ label: 'Privacy', href: '/deposition-timer/privacy' },
	];
	...
	return (
		<header
			className={cn(
				'sticky top-0 z-50 mx-auto w-full max-w-5xl border-b border-border bg-background/95 shadow backdrop-blur-lg md:top-4 md:rounded-md md:border md:transition-all md:ease-out',
				{
					'md:max-w-4xl': scrolled && !open,
		...
		>
			...
			>
				<a
					...
					className="max-w-[14rem] text-sm font-black leading-tight tracking-normal text-foreground sm:max-w-none sm:text-base"
					aria-label="Deposition Timer & Objection Log home"
				>
				...
				<div className="hidden items-center gap-2 md:flex">
					...
					<Button asChild>
						<a href="#pricing" aria-label="View lifetime unlock pricing">
							Get Started
						</a>
					</Button>
				</div>
				...
				>
					...
					<div className="flex flex-col gap-2">
						<Button asChild className="w-full">
							<a href="#pricing" aria-label="View lifetime unlock pricing" onClick={() => setOpen(false)}>
								Get Started
							</a>
						</Button>
					</div>
